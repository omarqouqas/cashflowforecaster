  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Quotes</h2>
        ...
        <>
          {quotes.length === 0 ? (
            <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-12 text-center">
              ...
              <p className="text-zinc-900 dark:text-zinc-100 font-semibold text-lg mb-2">No quotes yet</p>
              ...
              {summary && (
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                  <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-4">
                    <p className="text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Total Pending</p>
                    {Object.keys(summary.pendingByCurrency).length === 0 ? (
                      ...
                      <div className="space-y-1">
                        {Object.entries(summary.pendingByCurrency).map(([curr, amount]) => (
                          <p key={curr} className="text-lg font-bold text-zinc-900 dark:text-zinc-100 tabular-nums">
                  ...
                  <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-4">
                    <p className="text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Awaiting Response</p>
                    <p className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 tabular-nums">
                      {summary.awaitingResponse}
                    </p>
                  </div>
                  <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-4">
                    <p className="text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Accepted</p>
                    <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 tabular-nums">
                      {summary.accepted}
                    </p>
                  </div>
                  <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-4">
                    <p className="text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">Expiring Soon</p>
